...
describe("The user", () => {
  ...
  it("should be able to open the list of products", () => {
    browser.get("")
  ...
  it("should be able to open the details of a product", () => {
  ...
  it("should be able to see the view for product creation", () => {
    browser.get("#!/products")
