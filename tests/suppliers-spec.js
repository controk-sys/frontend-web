...
describe("The user", () => {
  ...
  it("should be able to open the list of suppliers", () => {
    browser.get("")
  ...
  it("should be able to open the details of a supplier", () => {
  ...
  it("should be able to navigate to the details of a supplier", () => {
  ...
  it("should be able to see the view for supplier creation", () => {
    browser.get("#!/suppliers")
