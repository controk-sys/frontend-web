...
describe("The user", () => {
  ...
  it("should be able to see the list of employees", () => {
    browser.get("")
  ...
  it("should be able to open the details of a employee", () => {
  ...
  it("should be able to navigate to the details of a employee", () => {
  ...
  it("should be able to see the view for employee creation", () => {
    browser.get("#!/employees")
